...
import { updateCoffeeSell } from "../../../api/coffeeSell";
import { toast } from "react-toastify";

const EditCoffeeSell = ({
  trackedProduct,
  setChecked
}) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
        const ress = await updateCoffeeSell(trackedProduct.id, editCount, token)
        setChecked((prev)=> prev.map((item)=> item.id === ress.data.id ? ress.data : item))
