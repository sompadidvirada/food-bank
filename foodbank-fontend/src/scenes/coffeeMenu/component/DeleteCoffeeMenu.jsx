...
import { deleteCoffeeMenu } from "../../../api/coffeeMenu";

const DeleteCoffeeMenu = ({ row,setCoffeeMenu }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const ress = await deleteCoffeeMenu(row?.id, token);
       setCoffeeMenu((prev) => prev.filter((menu) => menu.id !== ress.data.id));
...
export default DeleteCoffeeMenu;
