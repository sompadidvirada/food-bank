  ...
  return (
    ...
    >
      ...
      <IconButton
        ...
        sx={{ position: "absolute", right: 2, top: 2, zIndex: 2000, border:"1px white solid" }}
...
export default DialogDetailReport;
